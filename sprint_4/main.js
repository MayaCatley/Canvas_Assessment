...
let R = new InteractiveButton(40, 50, 100, 40, col[0][4], "rgba(255,255,255,0.25)", col[1][4], 'white', 'rectangle', col[0][2])
let E = new InteractiveButton(40, 100, 100, 40, col[0][6], "rgba(255,255,255,0.25)", col[1][6], 'white', 'ellipse', col[0][2])
...
let buttonSet = [R, E, RED, ORA, YEL, GRE, BLU, PIN, MAG, TEA, PUR, CYA]
